...
class HotelierRegistrationFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('agreeTerms', CheckboxType::class, [
                'label' => 'J\'accepte les conditions d\'utilisation et je confirme être autorisé à représenter mon établissement',
                'mapped' => false,
                'constraints' => [
                    new IsTrue([
